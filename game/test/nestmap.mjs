...
// roda no preview.
// Uso: node test/nestmap.mjs  ->  <tmp>/formigueiro-layout.png  (NESTMAP_OUT muda o destino)
...
const out = process.env.NESTMAP_OUT || path.join(tmpdir(), "formigueiro-layout.png");   // fora do repo
