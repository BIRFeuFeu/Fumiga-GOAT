 ...
 */
export const BIOMES = {
    bosque_umido: { name: 'Bosque Úmido', stage: 1, terrain: { rock: 0.05, hazard: 0.04 }, effect: 'none', enemies: ['boar', 'centipede', 'beetle', 'deer', 'hare'], boss: 'wolf_spider', light: '#7ad26a', fog: '#0d1408' },
    prado_fogo: { name: 'Prado de Fogo', stage: 1, terrain: { rock: 0.06, hazard: 0.1 }, effect: 'burn', enemies: ['ant', 'beetle', 'boar', 'fox'], boss: 'bombardier', light: '#ff7a2a', fog: '#180a04' },
    deserto_escaldante: { name: 'Deserto Escaldante', stage: 1, terrain: { rock: 0.08, hazard: 0.12 }, effect: 'sand', enemies: ['scorpion', 'termite', 'boar', 'hare'], boss: 'bombardier', light: '#ffd07a', fog: '#181004' },
    pantano_toxico: { name: 'Pântano Tóxico', stage: 1, terrain: { rock: 0.05, hazard: 0.14 }, effect: 'poison', enemies: ['fly', 'centipede', 'boar'], boss: 'putrid_centipede', light: '#9dff3c', fog: '#0a1204' },
    cemiterio_troncos: { name: 'Cemitério de Troncos', stage: 1, terrain: { rock: 0.14, hazard: 0.06 }, effect: 'hardrock', enemies: ['boar', 'termite', 'beetle', 'fox'], boss: 'wolf_spider', light: '#c8a05a', fog: '#120c06' },
